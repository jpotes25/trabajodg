...
@Component({
  selector: 'app-multimediadif',
  templateUrl: './multimediadif.component.html',
  styleUrls: ['./multimediadif.component.css']
})
export class MultimediadifComponent implements OnInit {
